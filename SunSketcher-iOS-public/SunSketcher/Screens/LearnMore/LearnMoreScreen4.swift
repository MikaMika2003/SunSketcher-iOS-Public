...
struct LearnMoreScreen4: View {
    @Environment(\.dismiss) private var dismiss
    let prefs = UserDefaults.standard
    
    let txt = "The size and shape of the Sun would help us learn more about flows in the interior and implications for models of gravity."
                        ...
                        ZStack {
                            ...
                            VStack {
                                ...
                                HStack {
                                    ...
                                    NavigationLink(destination: LearnMoreScreen5(), label: {
                                        Image("ic-rightarrow")
                                            .frame(width: geo.size.width * 0.10, height: geo.size.width * 0.08)
