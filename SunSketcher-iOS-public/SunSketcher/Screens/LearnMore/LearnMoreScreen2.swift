...
struct LearnMoreScreen2: View {
    @Environment(\.dismiss) private var dismiss
    let prefs = UserDefaults.standard
    
    let txt = "Using the app, your phone will capture images of the Sun during the eclipse as it forms Baily’s Beads, small flashes of light at the rim of the solar disc."
                        ...
                        ZStack {
                            ...
                            VStack {
                                ...
                                HStack {
                                    ...
                                    NavigationLink(destination: LearnMoreScreen3(), label: {
                                        Image("ic-rightarrow")
                                            .frame(width: geo.size.width * 0.10, height: geo.size.width * 0.08)
